...
{}grades中，class\_id依赖problem\_set_\\id、detail和total依赖评测结果（未给出），但是为了加速查询，保留数据冗余。\markdownRendererInterblockSeparator
...
{}\begin{center}\markdownRendererInterblockSeparator
{}\markdownRendererTable{}{5}{4}{cccc}%
{{字段名称}%
{类型}%
{索引}%
{外键}%
...
{}\begin{center}\markdownRendererInterblockSeparator
{}\markdownRendererTable{}{6}{4}{cccc}%
{{字段名称}%
{类型}%
{索引}%
{外键}%

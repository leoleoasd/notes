...
{}\markdownRendererUlBeginTight
\markdownRendererUlItem user(\underline{id},nickname,username,email,password,email_verified,created_at,updated_at)\markdownRendererUlItemEnd 
\markdownRendererUlItem role(\underline{id}, name, target)\markdownRendererUlItemEnd 
\markdownRendererUlItem user\markdownRendererEmphasis{has}roles(\underline{id}, user_id, )\markdownRendererUlItemEnd 

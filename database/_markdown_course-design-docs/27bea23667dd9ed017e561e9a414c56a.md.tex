...
{}\markdownRendererUlBeginTight
\markdownRendererUlItem user(\underline{id}, nickname, username, email, password, email\\markdownRendererEmphasis{verified, created\_at, updated\_at)\markdownRendererUlItemEnd 
\markdownRendererUlItem role(\underline{id}, name, target)\markdownRendererUlItemEnd 
\markdownRendererUlItem user\markdownRendererEmphasis{has}roles(\underline{id}, user\_id, )\markdownRendererUlItemEnd 
\markdownRendererUlItem token(\underline{id},)\markdownRendererUlItemEnd 

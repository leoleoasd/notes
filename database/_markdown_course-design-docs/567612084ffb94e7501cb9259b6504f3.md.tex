...
\markdownRendererUlItem webauthn\_credentials(\underline{id}, user\_id, content, last\_used)\markdownRendererUlItemEnd 
...
\markdownRendererInterblockSeparator
{}\end{center}\markdownRendererInterblockSeparator
{}\markdownRendererHeadingTwo{webauthn_credentials}\markdownRendererInterblockSeparator
{}\begin{center}\markdownRendererInterblockSeparator
{}\markdownRendererTable{}{5}{4}{cccc}%
{{字段名称}%
{类型}%

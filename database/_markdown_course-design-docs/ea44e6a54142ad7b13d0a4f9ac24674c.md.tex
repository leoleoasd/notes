...
{}\markdownRendererUlBeginTight
\markdownRendererUlItem user(\underline{id}, nickname, username, email, password, email\\markdownRendererEmphasis{verified, created\}at, updated\_at)\markdownRendererUlItemEnd 

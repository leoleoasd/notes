...
{}disclaimer: 本文档基于\markdownRendererLink{EduOJ}{https://github.com/EduOJ/backend}{https://github.com/EduOJ/backend}{}的数据库设计中的用户、班级、权限管理部分。\markdownRendererInterblockSeparator
